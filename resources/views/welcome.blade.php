...
<html lang="id" class="scroll-smooth" 
      ...
      x-init="darkMode = window.matchMedia('(prefers-color-scheme: dark)').matches; $watch('darkMode', val => document.documentElement.classList.toggle('dark', val))"
      :class="{ 'dark': darkMode }">
<head>
    <meta charset="utf-8">
...
<div id="loading" class="fixed inset-0 bg-white dark:bg-slate-900 z-50 flex items-center justify-center">
    <div class="text-center">
        ...
        <p class="text-lg font-semibold gradient-text">Loading Workout-in-Kos...</p>
    </div>
</div>

<div class="fixed bottom-6 right-6 z-40" x-data="{ showFAB: false }" x-show="showFAB" @scroll.window="showFAB = window.pageYOffset > 300">
...
<div x-data="{ 
    ...
    <div @click.away="isModalOpen = false" 
         class="bg-white dark:bg-slate-800 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl"
         x-show="isModalOpen"
         x-transition:enter="transition ease-out duration-300"
...
<header x-data="{ 
    ...
    <div class="container mx-auto px-6">
        <nav class="flex justify-between items-center py-4">
            <a href="#" class="text-3xl font-black gradient-text flex items-center gap-2">
                💪 Workout-Kos
            </a>
            ...
            <div class="flex items-center space-x-4">
                <div class="relative">
                    <button @click="notifications = !notifications" class="p-2 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors relative">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button @click="mobileMenu = !mobileMenu" class="lg:hidden p-2 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div x-show="mobileMenu" x-transition class="lg:hidden py-4 space-y-2">
            <a href="#fitur" class="block py-2 font-semibold hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Fitur</a>
        ...
        <div class="container mx-auto px-6">
            ...
            <div x-data="{ 
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="block text-lg font-semibold mb-2">Pilih Waktu Latihan</label>
                        <select x-model="workoutTime" class="w-full p-3 rounded-lg bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-600">
                    ...
                    <div>
                        <label class="block text-lg font-semibold mb-2">Pilih Jenis Latihan</label>
                        <div class="flex flex-wrap gap-3">
        ...
        <div class="container mx-auto px-6">
            ...
            <div x-data="{ 
                ...
                <div x-show="step === 4">
                    ...
                    <button @click="step = 1" class="w-full p-4 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition-all">Ulangi Kuis</button>
                </div>
            </div>
        </div>
    </section>

    <section id="tutorials" class="py-24 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-slate-800/50 dark:to-indigo-900/20">
        <div class="container mx-auto px-6">
            <div class="text-center mb-12">
            ...
            <div class="mb-8 flex flex-wrap gap-4 justify-center">
                <button x-on:click="filter = 'all'" class="px-4 py-2 rounded-full bg-indigo-600 text-white hover:bg-indigo-700 transition-all">Semua</button>
                <button x-on:click="filter = 'beginner'" class="px-4 py-2 rounded-full bg-indigo-600 text-white hover:bg-indigo-700 transition-all">Pemula</button>
                <button x-on:click="filter = 'intermediate'" class="px-4 py-2 rounded-full bg-indigo-600 text-white hover:bg-indigo-700 transition-all">Menengah</button>
                <button x-on:click="filter = 'advanced'" class="px-4 py-2 rounded-full bg-indigo-600 text-white hover:bg-indigo-700 transition-all">Lanjutan</button>
            </div>
            ...
            <div class="max-w-6xl mx-auto bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-slate-800/50 dark:to-indigo-900/20 rounded-3xl p-8 lg:p-12 shadow-2xl">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div class="relative">
                        ...
                        <button class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white/20 backdrop-blur-sm text-white p-6 rounded-full hover:bg-white/30 transition-all duration-300 animate-pulse">
